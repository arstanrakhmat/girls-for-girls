...
class VideoblogsListViewModel : ViewModel() {
    ...
    val video1 = VideoBlog(0, "Video 1", "21/12/22", "Бизнес", "Ширин Айтмак", TEXT,192,true, false, LINK)
    val video2 = VideoBlog(1, "Video 2", "01/10/22", "Будущее", "Нельсон Вумандела", TEXT,12,false, true, LINK2)
    val video3 = VideoBlog(2, "Video 3", "01/07/22", "Еда", "Unknown", TEXT,999,false, true, LINK)
    val video4 = VideoBlog(3, "Video 4", "08/06/22", "Образование","Султан Сарыгулов", TEXT,10000, true, false, LINK2)
    val video5 = VideoBlog(4, "Video 5", "02/12/21", "Программирование", "Какой-то чувак", TEXT,0,false, true, LINK)
